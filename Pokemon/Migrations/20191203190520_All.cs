        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pokemon_Color_ColorId",
                        column: x => x.ColorId,
                        principalTable: "Color",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pokemon_Gender_GenderId",
                        column: x => x.GenderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    PokemonsId = table.Column<int>(nullable: false),
                    PokemonId = table.Column<int>(nullable: true),
                    Seen = table.Column<int>(nullable: false),
                    Caught = table.Column<int>(nullable: false),
                    Lucky = table.Column<bool>(nullable: false),
                    Shiny = table.Column<bool>(nullable: false),
                    Shadow = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Go", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Go_Pokemon_PokemonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PokemonType", x => new { x.PokemonsId, x.PokeTypeId });
                    table.ForeignKey(
                        name: "FK_PokemonType_PokeType_PokeTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pokemon_GenderId",
                table: "Pokemon",
                column: "GenderId");

            migrationBuilder.CreateIndex(
                name: "IX_PokemonType_PokeTypeId",
                table: "PokemonType",
                column: "PokeTypeId");
        }
